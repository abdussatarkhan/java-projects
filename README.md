...
```mermaid
graph TD
    CLI[Console User Interface] --> Controller[Application Controller Layer]
    Controller --> Services[Business Domain Services]
    Services --> Models[Encapsulated Data Models & Persistence]
```
...
<p align="center">
  <img src="screenshots/01_dashboard_preview.png" alt="Java Enterprise Concurrency & Algorithms Showcase Preview" width="95%" />
</p>
